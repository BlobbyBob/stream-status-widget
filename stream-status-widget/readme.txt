...
Tags: stream, status, twitch, widget
Requires at least: 4.3
Tested up to: 4.6.1
License: GPLv2 or later
License URI: http://www.gnu.org/licenses/gpl-2.0.html

A plugin thats adding a widget to your wordpress site displaying whether your favorite streams on TTV are streaming or being offline.
...
1. Upload the plugin files to the `/wp-content/plugins/stream-status-widget` directory, or install the plugin through the WordPress plugins screen directly.
...
Just replace the images in `/wp-content/plugins/stream-status-widget/` directory
